...
<head>
    ...
    <style>
        ...
        * {
        ...
        .signal-card-1 { top: 42px; left: 24px; }
        .signal-card-2 { top: 78px; right: 24px; }
        .signal-card-3 { bottom: 124px; left: 38px; }
        .signal-card-4 { bottom: 56px; right: 32px; }
            ...
            <div class="hero-visual">
                <div class="orbital-panel">
                    ...
                    @foreach ($hero['signals'] as $signal)
                        <article class="signal-card signal-card-{{ $loop->iteration }}">
