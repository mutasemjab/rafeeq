...
<div class="page-header">
    <div class="page-header-left">
        <h1>{{ $locale === 'ar' ? 'إضافة خطة اشتراك' : 'Create Subscription Plan' }}</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ $locale === 'ar' ? 'إضافة' : 'Create' }}</li>
            </ol>
        </nav>
    </div>
...
<div class="admin-card">
    <div class="admin-card-header">
        <h3 class="admin-card-title">
            ...
            {{ $locale === 'ar' ? 'بيانات الخطة' : 'Plan Details' }}
        </h3>
    </div>
    <div class="p-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('name') }}"
                           required
                           placeholder="{{ $locale === 'ar' ? 'مثال: الخطة المجانية' : 'e.g. Free Plan' }}">
                ...
                <div class="col-md-3">
                    ...
                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                        ...
                        <option value="pro" {{ old('type') === 'pro' ? 'selected' : '' }}>
                ...
                <div class="col-md-3">
                    ...
                    <select name="billing_period" class="form-select @error('billing_period') is-invalid @enderror" required>
                        ...
                        <option value="lifetime" {{ old('billing_period') === 'lifetime' ? 'selected' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number"
                           ...
                           value="{{ old('max_documents_per_child') }}"
                           min="1"
                           placeholder="{{ $locale === 'ar' ? 'غير محدود' : 'Unlimited' }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="has_specialist_access"
                                       ...
                                       {{ old('has_specialist_access') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="has_progress_reports"
                                       ...
                                       {{ old('has_progress_reports') ? 'checked' : '' }}>
